...
class DefaultEmbed(Embed):
    def __init__(self, **kwargs):
        super().__init__(type="rich", colour=settings.COLOUR, **kwargs)
...
def send_embed_on_exception(func):
    """Decorator to send an embed if errors occurs during command processing. Exceptions
    are still raised after the embed is sent."""
